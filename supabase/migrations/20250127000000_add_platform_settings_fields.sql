...
ADD COLUMN IF NOT EXISTS platform_name VARCHAR(255) DEFAULT 'Meetmydesigners',
...
ADD COLUMN IF NOT EXISTS contact_address TEXT DEFAULT 'Meetmydesignerss Pvt Ltd, Plot No. C-54, G Block, Bandra Kurla Complex, Mumbai, Maharashtra 400051',
...
SET 
  platform_name = COALESCE(platform_name, 'Meetmydesigners'),
  ...
  contact_address = COALESCE(contact_address, 'Meetmydesignerss Pvt Ltd, Plot No. C-54, G Block, Bandra Kurla Complex, Mumbai, Maharashtra 400051'),
