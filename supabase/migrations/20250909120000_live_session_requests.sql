-- Create live_session_requests table
CREATE TABLE IF NOT EXISTS public.live_session_requests (
...
CREATE INDEX IF NOT EXISTS idx_live_session_requests_customer_id ON public.live_session_requests(customer_id);
CREATE INDEX IF NOT EXISTS idx_live_session_requests_designer_id ON public.live_session_requests(designer_id);
CREATE INDEX IF NOT EXISTS idx_live_session_requests_status ON public.live_session_requests(status);
CREATE INDEX IF NOT EXISTS idx_live_session_requests_created_at ON public.live_session_requests(created_at);
