-- Complete setup for How It Works section with video management
-- This script creates the table, sets up RLS policies, and inserts initial data

-- Create how_it_works_content table
