...
export function DashboardHeader({
  ...
  return (
    <header className="bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 px-4 sm:px-6 py-4 sm:py-8 relative">
      <div className="lg:min-h-[7rem] flex items-center overflow-hidden">
