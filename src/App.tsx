    ...
    <div className="min-h-screen w-full flex flex-col">
      ...
      <main className="flex-1">
        ...
        />
          ...
          {/* Designer Management */}
          <Route
            path="/admin/designer-verification"
            element={
              <ProtectedAdminRoute>
                <AdminLayout>
          ...
          />
          <Route
            path="/admin/designer-availability"
            element={
              <ProtectedAdminRoute>
                <AdminLayout>
          ...
          />
          <Route
            path="/admin/platform/commissions"
            element={
              <ProtectedAdminRoute>
                <AdminLayout>
                  <AdminCommissions />
          ...
          />
          <Route
            path="/admin/cms/success-stories"
            element={
              <ProtectedAdminRoute>
                <AdminLayout>
          ...
          />
          <Route
            path="/customer-dashboard/recent-designers"
            element={
              <ProtectedRoute requireUserType="client">
          ...
          />
          <Route
            path="/customer-dashboard/designers"
            element={
              <ProtectedRoute requireUserType="client">
                <CustomerDesigners />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/designer-dashboard/profile"
            element={
              <ProtectedRoute requireUserType="designer">
                <DesignerProfile />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/designer-dashboard/bookings"
            element={
              <ProtectedRoute requireUserType="designer">
                <DesignerBookings />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/designer-dashboard/file-reviews"
            element={
              <ProtectedRoute requireUserType="designer">
                <DesignerFileReviews />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/designer-dashboard/availability"
            element={
              <ProtectedRoute requireUserType="designer">
          ...
          />
          <Route
            path="/designer-dashboard/earnings"
            element={
              <ProtectedRoute requireUserType="designer">
                <DesignerEarnings />
              </ProtectedRoute>
          ...
          />
          <Route
            path="/designer-dashboard/history"
            element={
              <ProtectedRoute requireUserType="designer">
          ...
          />
          <Route
            path="/designer-dashboard/settings"
            element={
              <ProtectedRoute requireUserType="designer">
                <DesignerSettings />
              </ProtectedRoute>
