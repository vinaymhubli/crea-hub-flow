          ...
          <div className="p-4 sm:p-6 space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
              <Link to="/customer-dashboard/designers" className="group">
                <div className="relative overflow-hidden bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 h-24 sm:h-32 transition-all duration-300 hover:scale-105 hover:shadow-xl animate-fade-in">
                  ...
                  <div className="relative z-10 flex flex-col justify-between h-full text-white">
                    <Search className="w-5 h-5 sm:w-8 sm:h-8 mb-1 sm:mb-2" />
                    <div>
                      <h3 className="font-bold text-sm sm:text-lg">Find Designer</h3>
                      <p className="text-white/80 text-xs sm:text-sm hidden sm:block">Browse talented designers</p>
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <Link to="/customer-dashboard/bookings" className="group">
                <div className="relative overflow-hidden bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 h-24 sm:h-32 transition-all duration-300 hover:scale-105 hover:shadow-xl animate-fade-in" style={{animationDelay: '0.1s'}}>
                  <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 w-16 h-16 sm:w-24 sm:h-24 bg-white/10 rounded-full"></div>
                  <div className="relative z-10 flex flex-col justify-between h-full text-white">
                    <Calendar className="w-5 h-5 sm:w-8 sm:h-8 mb-1 sm:mb-2" />
                    <div>
                      <h3 className="font-bold text-sm sm:text-lg">My Bookings</h3>
                      <p className="text-white/80 text-xs sm:text-sm hidden sm:block">Manage your sessions</p>
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <Link to="/customer-dashboard/messages" className="group">
                <div className="relative overflow-hidden bg-gradient-to-br from-orange-500 to-red-500 rounded-xl sm:rounded-2xl p-4 sm:p-6 h-24 sm:h-32 transition-all duration-300 hover:scale-105 hover:shadow-xl animate-fade-in" style={{animationDelay: '0.2s'}}>
                  <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 w-16 h-16 sm:w-24 sm:h-24 bg-white/10 rounded-full"></div>
                  <div className="relative z-10 flex flex-col justify-between h-full text-white">
                    <MessageCircle className="w-5 h-5 sm:w-8 sm:h-8 mb-1 sm:mb-2" />
                    <div>
                      <h3 className="font-bold text-sm sm:text-lg">Messages</h3>
                      <p className="text-white/80 text-xs sm:text-sm hidden sm:block">Chat with designers</p>
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <Link to="/customer-dashboard/wallet" className="group">
                <div className="relative overflow-hidden bg-gradient-to-br from-violet-500 to-pink-500 rounded-xl sm:rounded-2xl p-4 sm:p-6 h-24 sm:h-32 transition-all duration-300 hover:scale-105 hover:shadow-xl animate-fade-in" style={{animationDelay: '0.3s'}}>
                  <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 w-16 h-16 sm:w-24 sm:h-24 bg-white/10 rounded-full"></div>
                  <div className="relative z-10 flex flex-col justify-between h-full text-white">
                    <Wallet className="w-5 h-5 sm:w-8 sm:h-8 mb-1 sm:mb-2" />
                    <div>
                      <h3 className="font-bold text-sm sm:text-lg">Wallet</h3>
                      <p className="text-white/80 text-xs sm:text-sm hidden sm:block">Manage your funds</p>
                    </div>
                  </div>
                </div>
              </Link>
              ...
              <CardContent className="p-4 sm:p-6 lg:p-8">
                {activeSession ? (
                  <div className="bg-gradient-to-r from-green-50 to-teal-50 rounded-lg p-4 sm:p-6 border border-green-200">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 mb-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="font-bold text-green-800 text-sm sm:text-base">Live Session</span>
                      </div>
                      <Link 
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-gray-800 mb-2 truncate">{activeSession.service}</h3>
                  ...
                  <div className="text-center">
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-gray-800 mb-2">No Active Sessions</h3>
                    <p className="text-gray-600 mb-4 text-sm sm:text-base">You don't have any active design sessions at the moment.</p>
                    <p className="text-xs sm:text-sm text-gray-500">Start by finding a designer and booking a session.</p>
                  </div>
                )}
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
                ...
                <CardContent className="p-4 sm:p-6 bg-gradient-to-br from-green-50 to-emerald-50">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-gray-600 mb-1 font-medium">Wallet Balance</p>
                      <p className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">₹{walletBalance.toFixed(2)}</p>
                      <Link to="/customer-dashboard/wallet" className="text-xs sm:text-sm text-green-600 hover:text-green-700 flex items-center mt-2 sm:mt-3 font-medium group">
              ...
              <Card className="overflow-hidden border-0 shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 animate-fade-in" style={{animationDelay: '0.6s'}}>
                <CardContent className="p-4 sm:p-6 bg-gradient-to-br from-blue-50 to-cyan-50">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-gray-600 mb-1 font-medium">Total Sessions</p>
                      <p className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">{completedBookings.length}</p>
                      <p className="text-xs sm:text-sm text-blue-600 mt-2 sm:mt-3 font-medium">Completed sessions</p>
                    </div>
              ...
              <Card className="overflow-hidden border-0 shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 animate-fade-in" style={{animationDelay: '0.7s'}}>
                <CardContent className="p-4 sm:p-6 bg-gradient-to-br from-yellow-50 to-orange-50">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-gray-600 mb-1 font-medium">Favorite Designers</p>
                      <div className="flex items-center space-x-2 mb-2 sm:mb-3">
                        <p className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">3</p>
                        <Star className="w-4 h-4 sm:w-6 sm:h-6 text-yellow-400 fill-current" />
                      </div>
                      <p className="text-xs sm:text-sm text-yellow-600 font-medium">In your network</p>
                    </div>
              ...
              <Card className="overflow-hidden border-0 shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 animate-fade-in" style={{animationDelay: '0.8s'}}>
                <CardContent className="p-4 sm:p-6 bg-gradient-to-br from-purple-50 to-pink-50">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-gray-600 mb-1 font-medium">Total Spent</p>
                      <p className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">₹450</p>
                      <p className="text-xs sm:text-sm text-purple-600 mt-2 sm:mt-3 font-medium">On design services</p>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              ...
              <Card className="overflow-hidden border-0 shadow-lg animate-fade-in" style={{animationDelay: '0.9s'}}>
                <CardHeader className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-4 sm:p-6">
                  ...
                  <CardDescription className="text-indigo-100 text-xs sm:text-sm">Your completed design projects</CardDescription>
                </CardHeader>
                <CardContent className="p-4 sm:p-6">
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg">
                      <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                          <FileImage className="w-5 h-5 sm:w-6 sm:h-6 text-blue-500" />
                        </div>
                        <div className="min-w-0 flex-1">
                          <h4 className="font-semibold text-gray-800 text-sm sm:text-base truncate">Company Rebrand</h4>
                          <p className="text-xs sm:text-sm text-gray-600 truncate">by Emma Thompson</p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg">
                      <div className="flex items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-100 to-teal-100 rounded-lg flex items-center justify-center flex-shrink-0">
                          <FileImage className="w-5 h-5 sm:w-6 sm:h-6 text-green-500" />
                        </div>
                        <div className="min-w-0 flex-1">
                          <h4 className="font-semibold text-gray-800 text-sm sm:text-base truncate">Website Banner</h4>
                          <p className="text-xs sm:text-sm text-gray-600 truncate">by Marcus Chen</p>
                        </div>
                      </div>
                      <div className="text-right flex-shrink-0 ml-2">
                        <p className="text-xs sm:text-sm font-medium text-green-600">Completed</p>
              ...
              <Card className="overflow-hidden border-0 shadow-lg animate-fade-in" style={{animationDelay: '1s'}}>
                <CardHeader className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white p-4 sm:p-6">
                  ...
                  <CardDescription className="text-teal-100 text-xs sm:text-sm">Your latest platform interactions</CardDescription>
                </CardHeader>
                <CardContent className="p-4 sm:p-6">
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      <div className="w-2 h-2 bg-gradient-to-r from-green-400 to-teal-500 rounded-full mt-2 flex-shrink-0"></div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs sm:text-sm font-medium text-gray-800 truncate">Project completed with Emma Thompson</p>
                        <p className="text-xs text-gray-500">Company Rebrand - 2 hours ago</p>
                      </div>
                      <Badge variant="outline" className="text-green-600 border-green-200 text-xs flex-shrink-0">Completed</Badge>
                    </div>
                    
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full mt-2 flex-shrink-0"></div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs sm:text-sm font-medium text-gray-800 truncate">Payment processed</p>
                        <p className="text-xs text-gray-500">₹80.00 - Yesterday</p>
                      </div>
                      <Badge variant="outline" className="text-blue-600 border-blue-200 text-xs flex-shrink-0">Payment</Badge>
                    </div>
                    
                    <div className="flex items-start space-x-3 sm:space-x-4">
                      <div className="w-2 h-2 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full mt-2 flex-shrink-0"></div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs sm:text-sm font-medium text-gray-800 truncate">New message from Marcus Chen</p>
                        <p className="text-xs text-gray-500">UI/UX feedback - 3 days ago</p>
                      </div>
                      <Badge variant="outline" className="text-purple-600 border-purple-200 text-xs flex-shrink-0">Message</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
