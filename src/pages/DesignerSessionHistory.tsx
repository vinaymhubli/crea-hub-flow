            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-white/80">Track your past design sessions and performance</p>
                </div>
              </div>
              
              <Button onClick={handleExportReport} className="bg-white/20 hover:bg-white/30 text-white border-white/20 flex items-center space-x-2">
