  ...
  const fetchComplaints = async () => {
    try {
      ...
      const customerIds = Array.from(
        new Set(complaintsList.map((c) => c.customer_id).filter(Boolean))
      );
      ...
      const fileIds = Array.from(
        new Set(complaintsList.map((c) => c.file_id).filter(Boolean))
      );
        ...
        <div className="flex min-h-screen bg-gray-50">
          <div className="flex-1 flex flex-col">
            <DashboardHeader
              ...
              subtitle="View and respond to customer complaints about your work"
              icon={
                        ...
                        <CardContent className="p-6">
                          <div className="flex items-start justify-between mb-4">
                            ...
                            <div className="flex gap-2">
                              <Badge
                                variant={getStatusBadge(complaint.status)}
                              ...
                              <Badge
                                variant={getPriorityBadge(complaint.priority)}
                              >
                                {complaint.priority}
                              </Badge>
                            </div>
                            ...
                            {complaint.status === "approved" && (
                              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                                ...
                                <p className="text-sm text-orange-800 mb-3">
                                  This complaint has been approved. Please
                                  upload a corrected version of the file.
                                </p>
                                <Button
                            ...
                            {complaint.status === "file_uploaded" && (
                              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                ...
                                <p className="text-sm text-blue-800">
                                  Your corrected file has been uploaded and is
                                  waiting for customer review.
                                </p>
                            ...
                            {complaint.status === "customer_approved" && (
                              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                ...
                                <p className="text-sm text-green-800">
                                  The customer has approved your corrected file.
                            ...
                            {complaint.status === "customer_rejected" && (
                              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                                ...
                                <p className="text-sm text-red-800 mb-3">
                                  The customer has rejected your corrected file.
                                ...
                                >
                                  <Upload className="w-4 h-4 mr-2" />
                                  Upload New Version (Attempt{" "}
                                  {(complaint.reupload_count || 0) + 1})
                                </Button>
                              </div>
                            )}
